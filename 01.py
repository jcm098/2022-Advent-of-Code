...
def part1(data):
    ...
    print("The elf with the most calories has " + str(mostCalories) + " calories.")   
    return mostCalories
...
def part2(data):
    ...
    print("The elf with the most calories has " + str(elfCalorieList[0]) + " calories.") 
    print("The elf with the second most calories has " + str(elfCalorieList[1]) + " calories.") 
    print("The elf with the third most calories has " + str(elfCalorieList[2]) + " calories.") 
